"""
Django settings for TravelFast project.
...
SECRET_KEY = '1%0i(g2303qe5r&ajdkz+ws$olfa79(o*p_#7tjs!py%fw(!(p'
...
WSGI_APPLICATION = 'TravelFast.wsgi.application'
